...
template <class Solver> class LogicEncoder {
public:
  // lifecycle
...
LogicEncoder<Solver>::LogicEncoder(Solver &solver) : solver_(solver) {}

// alias

template <class Solver> int LogicEncoder<Solver>::Compl(int nLit) {
...
template <class Solver> int LogicEncoder<Solver>::Or2(int nIn1, int nIn2) {
