...
namespace {
  ...
  void ConfigureHeloProgram(argparse::ArgumentParser &program) {
    ...
    program.add_argument("--optimizer")
      .default_value(0)
      .scan<'i', int>();
    program.add_argument("--optimizer-verbose")
      .default_value(0)
      .scan<'i', int>();
    program.add_argument("--analyzer")
      .default_value(0)
      .scan<'i', int>();
    program.add_argument("--analyzer-verbose")
      .default_value(0)
      .scan<'i', int>();
    program.add_argument("--simulator")
      .default_value(0)
      .scan<'i', int>();
    program.add_argument("--simulator-verbose")
      .default_value(0)
      .scan<'i', int>();
    program.add_argument("--sat")
      .default_value(0)
      .scan<'i', int>();
    program.add_argument("--sat-verbose")
      .default_value(0)
      .scan<'i', int>();
  ...
  void StoreHeloParams(BoopHeloParams *params, const argparse::ArgumentParser &program) {
