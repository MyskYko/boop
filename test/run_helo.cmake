...
execute_process(
  COMMAND "${HELO_EXECUTABLE}" "${INPUT_PATH}" "${OUTPUT_PATH}" --timeout 1
  RESULT_VARIABLE HELO_RESULT
)
if(NOT HELO_RESULT EQUAL 0)
  message(FATAL_ERROR "${TEST_NAME}: helo failed with exit code ${HELO_RESULT}")
endif()
